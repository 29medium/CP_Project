...
\\
\>[B]{}\Varid{discollect}\;((\Varid{b},\Varid{x})\mathbin{:}\Varid{y})\mathrel{=}[\mskip1.5mu (\Varid{b},\Varid{a})\mid \Varid{a}\leftarrow \Varid{x}\mskip1.5mu]\plus \Varid{discollect}\;\Varid{y}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{lltol}\mathbin{::}[\mskip1.5mu [\mskip1.5mu \Varid{a}\mskip1.5mu]\mskip1.5mu]\to [\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{lltol}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{lltol}\;(\Varid{h}\mathbin{:}\Varid{y})\mathrel{=}\Varid{h}\plus \Varid{lltol}\;\Varid{y}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{t}\;(\Varid{o},\Varid{l})\mathrel{=}\map \;(\lambda (\Varid{x},\Varid{y})\to ((\Varid{o}\plus \Varid{x}),\Varid{y}))\;(\Varid{lltol}\;\Varid{l}){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment teste1 p s d}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment     